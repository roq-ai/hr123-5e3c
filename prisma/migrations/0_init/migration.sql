...
-- AddForeignKey
ALTER TABLE "access_rights" ADD CONSTRAINT "access_rights_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "team" ADD CONSTRAINT "team_member_id_fkey" FOREIGN KEY ("member_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
