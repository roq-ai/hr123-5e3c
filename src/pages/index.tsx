  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to hr123 - Streamlining HR processes for enhanced efficiency and employee experience. Centralized data management, time tracking, and engagement tools at your fingertips. Boosting productivity and organizational success through automation."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to hr123 - Streamlining HR processes for enhanced efficiency and employee experience. Centralized data management, time tracking, and engagement tools at your fingertips. Boosting productivity and organizational success through automation.`}
            </Text>
            <Box
